...
const AdminDashboardMaterialRedux = () => {
  return (
    ...
    <div className="w-full">
      <div className="w-screen h-[30vh] lg:h-[40vh] relative">
        ...
        <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
          <h2 className="py-2 uppercase">Admin Dashboard</h2>
          <h3>Django/ MongoDB/ React/ Bootstrap/ Material UI/ Redux</h3>
        </div>
      </div>
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <h2>Overview</h2>
          <p>
            A admin dashboard developed in Django, MongoDB, React, Redux, and
            Material UI
          </p>
...
export default AdminDashboardMaterialRedux;
