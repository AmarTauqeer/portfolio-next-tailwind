          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
                ...
                <p className="pb-4 pt-2 text-white text-center uppercase">
                  ...
                  Toaster, STATE MANAGEMENT-Angular Signals, and DESIGN-
                  Material UI, Tailwind, SQL Server
                </p>
            ...
            >
              ...
              <div className="hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
                ...
                <p className="pb-4 pt-2 text-white text-center uppercase">
                  Dotnet Core, Dotnet Core Entityframework, Kafka, K8s,
                  Minikube, NextJS, NextUI, ReactJS, Tailwind, SQL Server
                </p>
            ...
            >
              ...
              <div className="hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
                ...
                <p className="pb-4 pt-2 text-white text-center">
                  Flask, Knowledge Graph, GraphDB, SPARQL, Swagger, bootstrap,
                  and React
                </p>
            ...
            >
              ...
              <div className="hidden group-hover:block absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
                ...
                <p className="pb-4 pt-2 text-white text-center">
                  Windows desktop application using C#, MSSQL SERVER, and
                  Crystal Reports.
                </p>
