    ...
    <div className="w-full h-screen text-center">
      <div className="max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center">
        <div>
          ...
          <p className="p-4 text-gray-600 max-w-[100%] m-auto text-xl">
            I'm an experienced and professional full-stack web developer having a Ph.D. degree in computer science.
          </p>
